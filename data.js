(function (global) {
  const USER_LOGIN = "Wanderley@stv.org";
  const USER_PASSWORD = "@w122jnheush";
  const ADMIN_LOGIN = "ArgnaldAndersen@stv.org.eg";
  const ADMIN_PASSWORD = "Vladmirandersen";
